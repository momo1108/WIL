...
document.querySelectorAll('#user-list tr').forEach(function (el) {
  ...
  function getComment(id) {
      ...
      if (xhr.status === 200) {
        ...
        comments.map(function (comment) {
          ...
          edit.addEventListener('click', function () { // 수정 클릭 시
            ...
            xhr.open('PATCH', '/mongo/comments/' + comment._id);
          ...
          remove.addEventListener('click', function () { // 삭제 클릭 시
            ...
            xhr.open('DELETE', '/mongo/comments/' + comment._id);
            xhr.send();
          });
          td = document.createElement('td');
          td.appendChild(edit);
    ...
    xhr.open('GET', '/mongo/comments/' + id);
    xhr.send();
  }
  // 사용자 등록 시
